...
- (void)updateFrameForSubviews {
    ...
    _separatorView.frame = CGRectMake(self.separatorInsetX, separatorY, size.width-2*self.separatorInsetX,_separatorHeight);
    ...
    if (!CGRectEqualToRect(_menuBar.frame, originalMenuFrame)) {
        _menuBar.verticalLineColor = self.separatorColor;
