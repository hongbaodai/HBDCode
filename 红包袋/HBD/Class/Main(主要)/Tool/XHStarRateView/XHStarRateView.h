...
@property (nonatomic, assign) NSInteger numberOfStars;  // 星星数量
@property (nonatomic,assign)CGFloat currentScore;   // 当前评分：0-5  默认0

@property (nonatomic,assign)BOOL isTap;       //是否支持手势，默认
...
-(instancetype)initWithOnlyShowStarFrame:(CGRect)frame CurrentScore:(CGFloat)currentScore;
